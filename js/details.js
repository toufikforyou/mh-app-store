const apps = [
  {
    ...
    apk: "https://github.com/toufikforyou/Mind-Color-Matching-Game/releases/latest/download/app-release.apk",
    ...
    videos: [],
    changelog: "Enhanced graphics, fixed minor bugs, and added 10 new challenging levels. Improved performance on older devices.",
    reviews: [
